...
interface BlockVanilla{
    ...
    public const POINTED_DRIPSTONE = 563; //564, 565
    public const COPPER_ORE = 566;
    public const LIGHTNING_ROD = 567; //568, 569, 570, 571
    public const DRIPSTONE = 572;
    public const ROOTED_DIRT = 573;
    public const HANGING_ROOTS = 574;
    public const MOSS = 575;
    public const SPORE_BLOSSOM = 576;
    public const CAVE_VINES = 577;
    public const BIG_DRIPLEAF = 578;
    public const AZALEA_LEAVES = 579;
    public const FLOWERED_AZALEA_LEAVES = 580;
    public const CALCITE = 581;
    public const AMETHYST = 582;
